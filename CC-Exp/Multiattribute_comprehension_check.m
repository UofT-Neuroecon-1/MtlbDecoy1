...
DrawFormattedText(mainwin,'This Lab is considered as an test room.\n Please turn your phone off and put it in your bag. \nPlease remain silent at all time.', 'center', 'center', 0, [], [], [], [1.5], [],centerRect);
Screen('Flip',mainwin);
KbStrokeWait;
...
for num_option= 2:4
    X_optim = OptimDesign( Particles, num_option, attrVals, attrSign, 'ADO' ); 
